...
read_parameters
...
through all the saved tests in the saved_reports, we traverse through each one and obtain:
...
def read_parameters():
    ...
    for dirName, subdirList, fileList in os.walk("."):
        ...
        #add more types of run tests if you wish to parse more and have more reports saved
